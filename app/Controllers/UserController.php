    ...
    public function node($request, $response, $args)
    {
        ...
        foreach ($nodes as $node) {
            ...
            foreach ($onlineLogs as $log) {
                ...
                if (in_array($sort, array(0, 7, 8, 10, 11, 12, 13, 14, 15, 16))) {
            ...
            $array_node['online'] = -1;
            if (!in_array($sort, array(0, 7, 8, 10, 11, 12, 13, 14, 15, 16)) || $node_heartbeat == 300) {
                $array_node['online'] = 0;
    ...
    public function getUserAllURL($request, $response, $args)
    {
        ...
        switch ($type) {
            ...
            case 'v2ray':
                ...
                break;
            case 'anytls':
                $return .= URL::get_NewAllUrl($user, ['type' => 'anytls', 'is_mu' => 0, 'emoji' => false]) . PHP_EOL;
                break;
            default:
                $return .= '悟空别闹！';
                break;
